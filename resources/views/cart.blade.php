...
<table id="cart" class="table table-hover table-condensed">
    ...
    <tr data-id="">
    @php $total += ($data->price +$data->add_price)* $data->quantity @endphp
                    <td data-th="Product">
                        <div class="row">
                    ...
                    <td data-th="Price">{{ $data->price }}VNĐ
                        <p>+{{$data->add_price}}</p>
                    </td>
                    <td data-th="Quantity">
                    ...
                    <td data-th="Subtotal" class="text-center">{{ (($data->price+$data->add_price) * $data->quantity) }}VNĐ</td>
                    <td class="actions" data-th="">
                        <!-- <button class="btn btn-danger btn-sm remove-from-cart"><i class="fa fa-trash-o"></i></button> -->
...
<div class="container">
<div class="row">
    <h1 class="text-center">Có thể bạn sẽ thích</h1>
