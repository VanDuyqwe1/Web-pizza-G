...
<body>
    <div class="type-1699" style="background: #adb0b6;">
        <div class="container">
            {{-- form search --}}
    ...
    @foreach ($products as $i)
        ...
        <div id="add-product{{ $i->id }}" class="login">
            ...
            <div class="wrapper">
                <form method="post" class="login-content" action="{{ route('add_Product', ['product_id' => $i->id]) }}" >
                    @csrf
                    ...
                    <select class="form-select form-select-sm" aria-label=".form-select-sm example" name="kichCo"
                     value="{{ old('kichCo') }}">
                        <option selected>Lựa chọn kích thước bánh</option>
                        <option value="1">Bánh nhỏ</option>
                        <option value="2">Bánh vừa</option>
                        <option value="3">Bánh lớn</option>
                    </select></label><br>
                    ...
                    <button class="button submit-button" type="submit" style="margin-top: 20px; margin-left:30%">Mua ngay</button>
                </form>
            </div>
